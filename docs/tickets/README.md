...
| [4.42](4.42-grille-tarifaire.md) | Grille tarifaire | FAIT | Amendé par le 4.43 avant toute livraison ; l'encaissement (Stripe Billing) est un ticket séparé ; écran fondateur de fermeture anticipée de l'offre |
| [4.43](4.43-correction-grille-tarifaire.md) | Correction de la grille (dossiers, WhatsApp, Solo/Équipe, jalons) | FAIT | Le comptage WhatsApp réel attend l'existence du canal ; formulaire de carte = ticket Stripe |
| [4.44](4.44-landing-mobile.md) | Landing : affichage mobile | FAIT | — |
