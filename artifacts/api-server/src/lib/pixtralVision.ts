/**
 * Pixtral document vision — extract structured info from an image
 * Model: pixtral-12b-2409
 *
 * SECURITY — trust boundary:
 * All Pixtral output is treated as attacker-controlled data.  A malicious
...
export async function analyzeDocumentImage(
  ...
  if (process.env.NODE_ENV !== "production") {
    console.warn("[pixtralVision] Zod parse failed:", result.error.issues);
  }
  return {
...
/** Map Pixtral document type → classeur category */
