...
ownerPool.connect().then(async (client) => {
  try {
    ...
    const APPEND_ONLY_TABLES = ["archived_pdfs", "envois_journal", "objectifs_franchissements", "paiements", "contact_bases", "oppositions", "incidents_facturation", "pa_documents_recus", "journal_decisions", "regles_relance", "usage_franchissements"];
