...
/**
 * Strict calendar date check. `Date.parse` normalises impossible dates
 * (e.g. 2026-02-31 → 2026-03-03) instead of rejecting them, which would
 * let an invoice with a non-existent issue date pass as `issuable: true` —
 * a conformity failure. The UTC round-trip catches any day/month overflow.
 */
